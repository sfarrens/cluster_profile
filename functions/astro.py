...
##
#  Function that checks if the input right
#  ascension is valid.
#
...
##
#  Function that checks if the input 
#  declination is valid.
#
...
##
#  Function that checks if the input object is
#  valid.
#
#  @param[in] obj: RA and Dec on input object.
#
def check_obj(obj):
